...
//        public LED7R LED = new LED7R(new[] { FEZHydra.Pin.PB8, FEZHydra.Pin.PB9, FEZHydra.Pin.PB12, FEZHydra.Pin.PB13, FEZHydra.Pin.PA26, FEZHydra.Pin.PA25, FEZHydra.Pin.PA27 });
  //      public Button Button = new Button(FEZHydra.Pin.PC9, FEZHydra.Pin.PC10);
        ...
        //kinematics
        public readonly IBody Body = new Body();

        public ILeg _legLeftFront;
        public ILeg _legLeftMiddle;
        public ILeg _legLeftRear;

        public ILeg _legRightFront;
        public ILeg _legRightMiddle;
        public ILeg _legRightRear;
        ...
        {
            _legLeftFront = new Leg3DOF(Body)
            {
            ...
            _legLeftMiddle = new Leg3DOF(Body)
            {
                BasePosition = Matrix4.Translate(0.0, 0.0, 0.0),
                CoxaLength = 35.0,
                FemurLength = 52.0,
            ...
            _legRightFront = new Leg3DOF(Body)
            {
                BasePosition = Matrix4.Translate(0.0, 0.0, 0.0),
                CoxaLength = 35.0,
                FemurLength = 52.0,
            ...
            _legRightMiddle = new Leg3DOF(Body)
            {
                BasePosition = Matrix4.Translate(0.0, 0.0, 0.0),
                CoxaLength = 35.0,
                FemurLength = 52.0,
            ...
            _legRightRear = new Leg3DOF(Body)
            {
                BasePosition = Matrix4.Translate(0.0, 0.0, 0.0),
                CoxaLength = 35.0,
                FemurLength = 52.0,
